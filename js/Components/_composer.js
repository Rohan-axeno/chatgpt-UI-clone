    ...
    window._generatingTimeout = setTimeout(function () {
      ...
      if (typeof appendAssistantMessage === "function") {
        ...
        if (
          ...
          appendAssistantMessage(mockResponses.list.text, {
            items: mockResponses.list.items,
          });
        } else if (
          ...
          appendAssistantMessage(mockResponses.table.text, {
            table: mockResponses.table.data,
          });
        } else if (
