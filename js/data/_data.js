    ...
    messages: [
      {
        role: "user",
        content:
          "How should I structure the backend to connect my Next.js healthcare app to a Python RAG service?",
      },
      {
        role: "assistant",
        content:
          "For your CareSafe project, a microservices architecture is highly effective. You can expose a REST API using FastAPI in Python. Your Node.js backend can then make HTTP POST requests to this service securely.",
        code: {
          language: "python",
    ...
    messages: [
      {
        role: "user",
        content:
          "What is the most efficient way to handle real-time digital whiteboard updates across multiple clients?",
      },
      {
        role: "assistant",
        content:
          "For a real-time collaborative Kanban board, integrating WebSockets via Socket.io with your MERN stack is the industry standard. It allows bidirectional communication so when one user moves a card, the server broadcasts that event to all connected clients instantly.",
      },
    ],
  },
  {
    ...
    messages: [
      {
        role: "user",
        content:
          "I have an interview tomorrow. What are some common HR and technical introductory questions I should prepare for?",
      },
      {
        role: "assistant",
        content:
          "Here are a few strong questions to prepare for your Jaro Education interview:",
        list: [
    ...
    messages: [
      {
        role: "user",
        content:
          "What specific data cleaning processes should I highlight for my e-commerce fashion recommendation presentation?",
      },
      {
        role: "assistant",
        content:
          "For your B.Tech major project presentation, I recommend highlighting these crucial data cleaning steps:",
        list: [
    ...
    messages: [
      {
        role: "user",
        content:
          "I am having trouble managing my remotes across multiple local directories. How do I add an origin and push my repository to GitHub correctly?",
      },
      {
        role: "assistant",
        content:
          "You can verify your current remote connections using `git remote -v`. To add a fresh origin and push your main branch, use the following terminal commands:",
        code: {
          language: "bash",
    ...
    messages: [
      {
        role: "user",
        content:
          "Compare React and Vue.js in terms of performance, ecosystem, and learning curve.",
      },
      {
        role: "assistant",
        content:
          "Here's a comparison of React and Vue.js across key dimensions:",
        table: {
...
const mockResponses = {
  general:
    "That's a great question! As a simulated frontend environment, I can render these chat bubbles flawlessly, but I am currently not connected to a live language model API. This response is a static mock demonstrating the UI interaction flow.",
...
const alternateResponses = {
  general:
    "Let me think about that differently. While this is a frontend-only simulation, the architecture demonstrates modern chat UI patterns including real-time message rendering, dynamic state management, and responsive layout behavior — all built with vanilla JavaScript.",
